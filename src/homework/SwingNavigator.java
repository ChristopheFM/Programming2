...
public class SwingNavigator {
    ...
    private static void createAndShowGUI() {
        ...
        /* Create the window */
        JFrame frame = new JFrame( "Swing Navigator" ); //JFrame default layout: BorderLayout
        ...
        navigationPanel.setLayout( new BoxLayout(navigationPanel, BoxLayout.PAGE_AXIS) ); //JPanel default: FlowLayout
 
 
        /* Create the speed text panel */
        final JPanel speedTextPanel = new JPanel(); //JPanel default layout: FlowLayout
...
//        speedSlider.setPaintLabels( true );
        ...
        final JPanel angleTextPanel = new JPanel(); //JPanel default layout: FlowLayout
        ...
        final JSlider angleSlider = new JSlider( ANGLE_MIN, ANGLE_MAX, ANGLE_INIT ); //Default: JSlider.HORIZONTAL
        /* Labels */
